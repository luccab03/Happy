...
export default function OrphanageDetails() {
    const params = useRoute().params as OrphanageDetailsRoute;
        ...
        <ScrollView style={styles.container}>
            ...
            <View style={styles.detailsContainer}>
                ...
                <View style={styles.mapContainer}>
                    ...
                    <TouchableOpacity onPress={() => { openMaps(parseFloat(orphanage.latitude), parseFloat(orphanage.longitude)) }} style={styles.routesContainer}>
